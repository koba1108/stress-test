...
class MetricsTaskSet(TaskSet):
    ...
    @task
    def tool_conversion_notice(self):
        self.client.get("/partners/edit/1#tab_4")
    ...
    @task
    def site_add(self):
        self.client.get("/sites/add")

    @task
    def site_edit(self):
        self.client.get("/sites/edit/1")
    ...
    @task
    def faq(self):
        self.client.get("/pages/faq")

    @task
    def profile(self):
        self.client.get("/partners/edit/1")
